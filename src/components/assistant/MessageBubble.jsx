                        ...
                        {isUser ? (
                            ...
                            <ReactMarkdown 
                                ...
                                components={{
                                    ...
                                    a: ({ children, ...props }) => (
                                        <a {...props} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-700 underline">{children}</a>
                                    ),
                                    ...
                                    th: ({ children }) => (
                                        <th className="px-3 py-2 text-left font-medium text-slate-700">{children}</th>
                                    ),
                                    td: ({ children }) => (
